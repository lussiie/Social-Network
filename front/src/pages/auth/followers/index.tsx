    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-950 via-violet-950 to-slate-950 px-4 py-12">
      ...
      <div className="mx-auto w-full max-w-2xl">
        ...
        <div className="mb-8 rounded-[2rem] border border-violet-500/10 bg-gradient-to-br from-purple-950 via-violet-950 to-slate-950/90 p-6 shadow-[0_35px_120px_-60px_rgba(79,70,229,0.35)] backdrop-blur-xl ring-1 ring-white/5">
          <p className="text-sm uppercase tracking-[0.35em] text-violet-300 text-center">Community</p>
          <h2 className="mt-3 text-4xl font-semibold text-white text-center">
            👥 Your Followers
          </h2>
          <p className="mt-3 text-center text-slate-400">People who follow your journey</p>
        </div>
        ...
        <div className="space-y-4">
          ...
          {followers.map((user) => (
            ...
            >
              ...
              {/* BUTTON */}
              <button className="rounded-2xl bg-gradient-to-r from-fuchsia-500 via-purple-500 to-indigo-500 px-5 py-2 text-sm font-semibold text-white shadow-lg shadow-fuchsia-500/20 transition duration-200 hover:scale-105 hover:brightness-110">
                Follow
              </button>
